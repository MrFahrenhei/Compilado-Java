...
public class Main {
	...
	public static void main(String[] args) {
		...
		Cliente cliente3 = new Cliente("Danier");
		...
		//System.out.println("\n");
		Pedido pedido1 = new Pedido(cliente1, pizza1,Pagamento.CARTAO.getInfo(), (pizza1.getPrice()));
		System.out.println(pedido1);
		pedido1.gerarNotaFiscal();
		System.out.println("\n");
		Pedido pedido2 = new Pedido(cliente2, lanche1 ,Pagamento.CARTAO.getInfo(), (lanche1.getPrice()));
		System.out.println(pedido2);
		pedido2.gerarNotaFiscal();
		System.out.println("\n");
		Pedido pedido3 = new Pedido(cliente3, salgado1, Pagamento.DINHEIRO.getInfo(), salgado1.getPrice());
